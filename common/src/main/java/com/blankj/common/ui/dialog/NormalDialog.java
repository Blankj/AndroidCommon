...
public class NormalDialog {
    ...
    public NormalDialog(Builder builder) {
        ...
        mDialogView.setMinimumHeight((int) (ScreenUtils.getScreenHeight() * builder.getHeight()));
        mDialog.setContentView(mDialogView);

        Window dialogWindow = mDialog.getWindow();
        WindowManager.LayoutParams lp = dialogWindow.getAttributes();
        lp.width = (int) (ScreenUtils.getScreenWidth() * builder.getWidth());
        ...
        mRightBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (mBuilder.getOnclickListener() != null) {
                    ...
                    mBuilder.getOnclickListener().clickRightButton(NormalDialog.this,
                            mRightBtn);
                }
    ...
    public static class Builder {
        ...
        private DialogInterface.OnLeftAndRightClickListener<NormalDialog> onclickListener;
        private DialogInterface.OnSingleClickListener<NormalDialog> singleListener;
        ...
        public DialogInterface.OnLeftAndRightClickListener<NormalDialog> getOnclickListener() {
